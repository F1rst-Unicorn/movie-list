...
public class GenrePage extends LoggedInWebpage {
    ...
    public GenrePage assertGenre(int index, String name, int count) {
        index++;
        assertTrue(index >= 1);
    ...
    public GenreDetailPage clickOnGenre(int index) {
        index++;
        assertTrue(index >= 1);
        assertTrue(index < getTableRowCount());
    ...
    public GenrePage assertNumberOfGenres(int expected) {
        // +1 for headline row
